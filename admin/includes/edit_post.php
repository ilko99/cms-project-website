...
if(isset($_GET['p_id'])){
 ...
 if(isset($_POST['update_post'])){
    ...
    $post_picture = escape($_FILES['post_picture']['name']);
    $post_picture_temp = escape($_FILES['post_picture']['tmp_name']);
    $post_content = escape($_POST['post_content']);
    $post_tags = escape($_POST['post_tags']);

    move_uploaded_file($post_picture_temp, "../images/$post_picture");
    ...
    $query .= "post_picture = '{$post_picture}' ";
...
<div class="form-group">
    <img width="100" src="../images/<?php echo $post_picture ?>" alt="">
